...
%LKR
%\newcommand\xkcdscale{0.5}
%\newcommand\xkcdpath{problems}
%\newcommand\xkcdcomment{}
...
\long\def\thud@mkchaphdstub#1#2#3{%
    ...
    #1%% Either \iftrue or \iffalse
        \ifnum\c@secnumdepth>\m@ne\relax
            \if@mainmatter
                {\thud@gigantic\thechapter
% LKR
%\captionsetup[figure]{justification=justified,singlelinecheck=false}
%\begin{wrapfigure}[0]{l}{0.90\textwidth}
%            	\vspace{-150pt}
%            	\includegraphics[width=\xkcdscale\textwidth]{xkcd/\xkcdpath.png}
%            	\caption*{[xkcd.org] \xkcdcomment}
%\end{wrapfigure}
...
\def\maketitle{
    \begin{titlepage}%
        \noindent%
        \ifpdf\makebox[\z@][l]{\raisebox{-.98\textheight}[\z@][\z@]{\includegraphics[height=\textheight]{BookFront}}}\fi%
